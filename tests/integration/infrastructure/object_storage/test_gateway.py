...
async def test_upload_file_object(
    ...
    await object_storage_gateway.upload_file_object(file_object=file_object_to_upload, name="some_binary_file.format")
...
async def test_upload_file(
    ...
    await object_storage_gateway.upload_file(file_path=file_to_upload.name, name="some_binary_file.format")
...
async def test_get_file_object(
    ...
    await object_storage_gateway.upload_file_object(file_object=file_object_to_upload, name="some_binary_file.format")
    file_obj = await object_storage_gateway.get_file_object("some_binary_file.format")
...
async def test_get_file(
    ...
    await object_storage_gateway.upload_file(file_path=file_to_upload.name, name="some_binary_file.format")
    file_presigned_url = await object_storage_gateway.get_file_presigned_url("some_binary_file.format")
    try:
